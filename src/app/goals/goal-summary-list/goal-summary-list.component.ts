...
@Component({
  selector: 'vita-goal-summary-list',
  templateUrl: './goal-summary-list.component.html',
  styleUrls: ['./goal-summary-list.component.sass'],
})

export class GoalSummaryListComponent implements OnInit {
